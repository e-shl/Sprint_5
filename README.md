...
(By.XPATH, '//a[@href="/account"]')                                                     # Ссылка/Кнопка «Личный кабинет»

(By.XPATH, '//*[contains(@class,"tab_tab") and contains(.,"Булки")]')                   # Вкладка "Булки"

(By.XPATH, '//*[contains(@class,"tab_tab_type_current") and contains(.,"Булки")]')      # Выбранная Вкладка "Булки"

(By.XPATH, '//*[contains(@class,"tab_tab") and contains(.,"Соусы")]')                   # Вкладка "Соусы"

(By.XPATH, '//*[contains(@class,"tab_tab_type_current") and contains(.,"Соусы")]')      # Выбранная Вкладка "Соусы"

(By.XPATH, '//*[contains(@class,"tab_tab") and contains(.,"Начинки")]')                 # Вкладка "Начинки"

(By.XPATH, '//*[contains(@class,"tab_tab_type_current") and contains(.,"Начинки")]')    # Выбранная Вкладка "Начинки"

(By.XPATH,'//h2[contains(text(),"Булки")]')                                             # Заголовок раздела "Булки"

(By.XPATH,'//h2[contains(text(),"Соусы")]')                                             # Заголовок раздела "Соусы"

(By.XPATH,'//h2[contains(text(),"Начинки")]')                                           # Заголовок раздела "Начинки"

(By.XPATH, '//button[contains(text(),"Войти в аккаунт")]')                              # Кнопка «Войти в аккаунт»

(By.XPATH, '//button[contains(text(),"Оформить заказ")]')                               # Кнопка «Оформить заказ»
# https://stellarburgers.nomoreparties.site/register
(By.XPATH,'//*[contains(text(),"Имя")]/parent::*/input')                                # Поле Имя

(By.XPATH, '//button[contains(text(),"Зарегистрироваться")]')                           # Кнопка Зарегистрироваться

(By.XPATH, '//*[contains(text(),"Пароль")]/ancestor::div[contains(@class,"input__container")]
//p[contains(@class, "input__error")]')                                                 # Текст ошибки поля Пароль
# https://stellarburgers.nomoreparties.site/login
(By.XPATH, '//button[contains(text(),"Войти")]')                # Кнопка Войти

(By.XPATH, '//*[contains(@class,"AppHeader_header__logo")]')    # Логотип Stellar Burgers
# https://stellarburgers.nomoreparties.site/register
# https://stellarburgers.nomoreparties.site/login
(By.XPATH, '//*[contains(text(),"Email")]/parent::*/input')     # Поле Email

(By.XPATH, '//*[contains(text(),"Пароль")]/parent::*/input')    # Поле Пароль
# https://stellarburgers.nomoreparties.site/account
(By.XPATH, '//button[text()="Выход"]')                          # Кнопка Выход

(By.XPATH, '//*[contains(@class, "Profile_profileList_")]')     # Форма редактирования профиля